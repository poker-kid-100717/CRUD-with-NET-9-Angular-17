...
- Create Angular project with ng: `ng new crud-with-net-9-angular-17.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`crud-with-net-9-angular-17.client.esproj`).
